...
export default function Site({lang="de"}) {
  ...
  return <main dir={rtl?"rtl":"ltr"}>
    ...
    <section id="quote" className="quote">
      <div className="quoteLead"><p className="eyebrow">ANGEBOT</p><h2>{t.quote}</h2><p>{quoteLead[0]}</p><div className="quoteContact"><b>{quoteLead[1]}</b><a href="tel:+436602660066">+43 660 266 00 66</a><a href="mailto:info@wientransport.at">info@wientransport.at</a></div></div>
    ...
    <section className="finalCta">
      ...
      <div className="finalCtaActions">
        <a className="primary" href="#quote">{t.cta}</a>
        <a className="secondary" href={`tel:+${phone}`}>+436602660066</a>
      </div>
    </section>
